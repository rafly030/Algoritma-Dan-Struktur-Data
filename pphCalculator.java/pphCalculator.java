...
public class pphCalculator {
    public static void main(String[] args) {
        ...
        System.out.print("Masukkan penghasilan netto dalam satu tahun: 70000000");
        netto = input.nextDouble();

        System.out.print("Masukkan status wajib pajak (1: single, 2: married): 1");
        status = input.nextInt();

        System.out.print("Masukkan jumlah anggota keluarga yang menjadi tanggungan: 3");
